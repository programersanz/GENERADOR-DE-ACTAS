...
<p>
  ...
  <td><input  class='form-control' type='hidden' name='n_acta[]'  id='n_acta' placeholder='acta' required value="<?=$r->n_acta+1?>"/></td>    
...
nuevaFila+="<td><input class='form-control' type='hidden' name='n_acta[]'  id='n_acta' placeholder='acta"+ " ' required value='<?=$r->n_acta+1?>'/> </td>"+
"<td><input class='form-control' type='text' name='nombre[]'  id='nombre' placeholder='Nombres"+ " ' required /> </td>"+
"<td><input class='form-control' type='text' name='apellido[]' id='apellido' placeholder='Apellidos" +"' required /> </td>"+
